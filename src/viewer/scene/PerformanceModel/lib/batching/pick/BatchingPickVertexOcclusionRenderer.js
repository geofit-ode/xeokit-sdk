...
import {BatchingPickVertexOcclusionShaderSource} from "./BatchingPickVertexOcclusionShaderSource.js";

/**
 * @private
 */
class BatchingPickVertexOcclusionRenderer {

    constructor(scene) {
        this._scene = scene;
        this._hash = this._getHash();
        this._shaderSource = new BatchingPickVertexOcclusionShaderSource(this._scene);
        this._allocate();
    }
...
export {BatchingPickVertexOcclusionRenderer};