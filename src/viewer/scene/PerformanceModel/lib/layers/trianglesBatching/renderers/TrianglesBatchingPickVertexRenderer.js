 ...
 * @private
 */
class TrianglesBatchingPickVertexRenderer {
    ...
    drawLayer(frameCtx, batchingLayer, renderPass, axis) {
    ...
    _buildVertexShader() {
        ...
        src.push("// Triangles batching vertex-pick vertex shader");
    ...
    _buildFragmentShader() {
        ...
        src.push("// Triangles batching vertex-pick fragment shader");
        ...
        src.push("vec4 packFloat(const in float value) {");
        ...
        src.push("  vec4 res = fract(value * bitShift);");
        ...
        src.push("    if (axis == 0.0) {");
        src.push("          gl_FragColor = packFloat(vViewPosition.x); ");
        src.push("    }else if (axis == 1.0) {");
        src.push("          gl_FragColor = packFloat(vViewPosition.y); ");
        src.push("    }else {");
        src.push("          gl_FragColor = packFloat(vViewPosition.z); ");
        src.push("    }");
...
export {TrianglesBatchingPickVertexRenderer};