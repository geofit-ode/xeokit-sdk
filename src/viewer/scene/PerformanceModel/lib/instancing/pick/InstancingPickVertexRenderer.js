...
import {InstancingPickVertexShaderSource} from "./InstancingPickVertexShaderSource.js";
 ...
 * @private
 */
class InstancingPickVertexRenderer {

    constructor(scene) {
        this._scene = scene;
        this._hash = this._getHash();
        this._shaderSource = new InstancingPickVertexShaderSource(this._scene);
        this._allocate();
    }
    ...
    drawLayer(frameCtx, layer, axis) {
        ...
        instanceExt.drawElementsInstancedANGLE(gl.POINTS, state.indicesBuf.numItems, state.indicesBuf.itemType, 0, state.numInstances);
...
export {InstancingPickVertexRenderer};