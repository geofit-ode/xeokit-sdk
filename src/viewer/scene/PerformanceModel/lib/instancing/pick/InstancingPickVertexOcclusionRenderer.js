...
import {InstancingPickVertexOcclusionShaderSource} from "./InstancingPickVertexOcclusionShaderSource.js";

/**
 * @private
 */
class InstancingPickVertexOcclusionRenderer {

    constructor(scene) {
        this._scene = scene;
        this._hash = this._getHash();
        this._shaderSource = new InstancingPickVertexOcclusionShaderSource(this._scene);
        this._allocate();
    }
...
export {InstancingPickVertexOcclusionRenderer};