 ...
 * @private
 */
const InstancingPickVertexOcclusionShaderSource = function (scene) {
...
function buildVertex(scene) {
    ...
    const src = [];
    src.push("// Instancing pick vertex occlusion vertex shader");
...
function buildFragment(scene) {
    ...
    const clipping = sectionPlanesState.sectionPlanes.length > 0;
    const src = [];
    src.push("// Instancing pick vertex occlusion fragment shader");
...
export {InstancingPickVertexOcclusionShaderSource};